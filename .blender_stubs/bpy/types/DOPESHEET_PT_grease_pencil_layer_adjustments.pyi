...
from .GreasePencil_LayerAdjustmentsPanel import GreasePencil_LayerAdjustmentsPanel
from .Panel import Panel
from .Constraint import Constraint
from .UILayout import UILayout
class DOPESHEET_PT_grease_pencil_layer_adjustments(GreasePencilLayersDopeSheetPanel, GreasePencil_LayerAdjustmentsPanel, Panel):
    layout: 'UILayout'
    text: str
