...
from .GreasePencil_LayerRelationsPanel import GreasePencil_LayerRelationsPanel
from .Panel import Panel
from .Constraint import Constraint
from .UILayout import UILayout
class DOPESHEET_PT_grease_pencil_layer_relations(GreasePencilLayersDopeSheetPanel, GreasePencil_LayerRelationsPanel, Panel):
    layout: 'UILayout'
    text: str
