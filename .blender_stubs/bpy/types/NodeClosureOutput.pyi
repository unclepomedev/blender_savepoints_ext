...
from .NodeClosureInputItem import NodeClosureInputItem
from .NodeClosureInputItems import NodeClosureInputItems
from .NodeClosureOutputItem import NodeClosureOutputItem
from .NodeClosureOutputItems import NodeClosureOutputItems
from .NodeInputs import NodeInputs
from .NodeLink import NodeLink
from .NodeOutputs import NodeOutputs
from .NodeSocket import NodeSocket
class NodeClosureOutput(NodeInternal):
    type: str
    location: list[float]
